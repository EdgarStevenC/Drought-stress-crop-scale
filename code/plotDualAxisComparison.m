...
yyaxis left
h1 = plot(1:8, rpi_values_vector, 'b-o', 'LineWidth', 3.5, 'MarkerSize', 12, 'MarkerFaceColor', 'blue', 'MarkerEdgeColor', [0 0 0.5]);
...
yyaxis right
h2 = plot(1:8, TWI_values_vector, 'r-s', 'LineWidth', 3.5, 'MarkerSize', 12, 'MarkerFaceColor', 'red', 'MarkerEdgeColor', [0.5 0 0]);
